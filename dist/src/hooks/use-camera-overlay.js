...
function useCameraOverlay() {
    ...
    const computeCameraOverlayGeometry = (args) => {
        const { canvasWidth, canvasHeight, overlayW, overlayH, overlayRadiusPx, padding, camVideoW, camVideoH, } = args;
    ...
    const createCameraOverlay = async (opts) => {
        ...
        const updateGeometry = (canvasWidth, canvasHeight) => {
            if (!camVideoEl) {
                clipPath = null;
                return;
            }
...
//# sourceMappingURL=use-camera-overlay.js.map