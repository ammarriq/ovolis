...
export async function startRecording(sourceId, sourceName) {
    try {
...
export async function saveRecording(filePath, buffer) {
    try {
...
export async function saveRecordingWithoutConversion(filePath, buffer) {
    try {
        // Ensure the directory exists
        const dir = path.dirname(filePath);
        await import("fs").then((fs) => fs.promises.mkdir(dir, { recursive: true }));
...
//# sourceMappingURL=start-recording.js.map