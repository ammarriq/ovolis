...
export async function takeScreenshot() {
    try {
        ...
        const appWindowTitles = new Set(BrowserWindow.getAllWindows()
        ...
        const isScreen = (id) => id.toLowerCase().startsWith("screen:");
        const isWindow = (id) => id.toLowerCase().startsWith("window:");
...
//# sourceMappingURL=take-screenshots.js.map